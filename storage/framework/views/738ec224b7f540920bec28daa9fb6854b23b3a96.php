...
<div class="panel panel-default">
<div class="panel-heading">
    <h4 class="panel-title">Изменить книгу</h4>
</div>
<div class="panel-body">
    <form class="form-horizontal" method="POST" action="<?php echo e(url('/admin/books/'.$book->id)); ?>" enctype="multipart/form-data"> 
    <?php echo e(csrf_field()); ?>  
    <div class="form-group">
        <label class="control-label col-sm-4" for="name">Название:</label>
        <div class="col-sm-7">
             <input type="text" class="form-control" name="name" id="name" value="<?php echo e($book->books_name); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-7">
            ...
            <?php $__currentLoopData = $headings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $heading): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($heading->id==$book->books_heading): ?>
                    <option value="<?php echo $heading->id; ?>" selected><?php echo $heading->heading_name; ?></option>
                <?php else: ?>
        ...
        <div class="col-sm-7">
            <select name="lang" class="form-control">
                <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($lan->id==$book->books_lang): ?>
                        <option value="<?php echo $lan->id; ?>" selected><?php echo $lan->languages_name; ?></option>
                    <?php else: ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
             <input type="text" class="form-control" name="pages" id="pages" value="<?php echo e($book->books_pages); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <select name="phouse" class="form-control">
                <?php $__currentLoopData = $phouses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phouse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($phouse->id==$book->books_phouse): ?>
                        <option value="<?php echo $phouse->id; ?>" selected><?php echo $phouse->phouses_name; ?></option>
                    <?php else: ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
             <input type="text" class="form-control" name="year" id="year" value="<?php echo e($book->books_year); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-sm-4" for="descrip">Описание:</label>
        <div class="col-sm-7">
            <input type="text" class="form-control" name="descrip" id="descrip" value="<?php echo e($book->books_descrip); ?>">
        </div>
    </div>
    <div class="form-group"> 
