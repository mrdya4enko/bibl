        ...
        <nav id="categories">
            <ul>
                <li>
                    ...
                    <ul>
                        <li>
                            <a href="">Программирование</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">История</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">Математика</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">Бизнес</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">Механика</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">Экология</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">Английский язык</a> <span class="toggle"></span>
                        </li>
                        <li>
                            <a href="">Немецкий язык</a> <span class="toggle"></span>
                        </li>
                         <li>
                            <a href="">Кыргызский язык</a> <span class="toggle"></span>
                        </li> <li>
                            <a href="">Русский язык</a> <span class="toggle"></span>
                        </li>
                         <li>
                            <a href="">Физика</a> <span class="toggle"></span>
                        </li> <li>
                            <a href="">Начертальная геометрия</a> <span class="toggle"></span>
                        </li>

                         <li>
                            <a href="">Химия</a> <span class="toggle"></span>
                        </li>
