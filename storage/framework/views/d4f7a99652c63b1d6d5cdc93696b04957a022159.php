    ...
    <?php if(count($books)>0): ?>
        <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-sm-6 well">
                ...
                <div class="col-sm-8">
                <h4><a href="<?php echo e(url('/books/'.$book->id)); ?>"><?php echo e($book->books_name); ?></a></h4>
                ...
                <h5>Направление: <a href="<?php echo e(url('/kategory/'.$book->heading->id)); ?>"><?php echo e($book->heading->heading_name); ?></a></h5>
